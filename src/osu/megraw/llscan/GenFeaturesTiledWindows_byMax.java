 ...
 *
 */
public class GenFeaturesTiledWindows_byMax {
	...
	public static void main(String[] args) {
		try {
			GenFeaturesTiledWindows_byMax genFeaturesTiledWindows = new GenFeaturesTiledWindows_byMax();
...
//        ArrayList<String> futureSeqNames = new ArrayList<String>();
     ...
     // file to output mapped genomic coordinates to
        ...
        for (int i = 0; i < sequenceCharArr.length; i++) {
        	...
        	ComputeLoglikScoreTile_byMax computeLoglikScoreThread = new ComputeLoglikScoreTile_byMax(sequenceCharArr[i], scoreCutOffs, 
        			nucsDownStream, BG_WIN, seqName, pwms, windowsHash, winsWidth ,maxScores);
...
//		ArrayList <LoglikScoreResult> finalResults = new ArrayList <LoglikScoreResult>();
        ...
        outFileVars.print("\tGCcontent_tile\tCAcontent_tile\tGAcontent_tile");
        outFileVars.println();
        ...
        for (int i = 0; i < finalResults.size(); i++) {
	        ...
	        for (String seqCont : seqContentNames) {
	        	outFileVars.print("\t" + res.featureHash.get(seqCont));
			}
            outFileVars.println();
        }
        outFileVars.flush();
...
//                }
	...
	public GenFeaturesTiledWindows_byMax() {
	}
